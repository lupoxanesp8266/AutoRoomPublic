	...
	public void stateChanged(ChangeEvent e) {
		...
		case "consignaSlider":
			...
			AutoRoom.mainFrame.getComfort().getConsignaLabel()
					.setText(AutoRoom.mainFrame.getComfort().getConsignaSlider().getValue() + "ºC");
			AutoRoom.DATACLOUD.getDB().child("comfort").child("consigna")
					.setValueAsync(AutoRoom.mainFrame.getComfort().getConsignaSlider().getValue());
			break;
		}
	}
